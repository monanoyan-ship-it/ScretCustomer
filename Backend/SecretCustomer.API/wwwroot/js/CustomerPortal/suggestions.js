    ...
    self.exportToExcel = function() {
        ...
        customerApiFetch(url)
            ...
            .then(function(blob) {
                ...
                a.href = url;
                a.download = 'OnerilerRaporu_' + formatLocalDate(new Date()) + '.xlsx';
    ...
    self.exportTopQuestionsToExcel = function() {
        ...
        customerApiFetch(url)
            ...
            .then(function(blob) {
                ...
                var a = document.createElement('a');
                a.href = url;
                a.download = 'EnCokOnerilenSorular_' + formatLocalDate(new Date()) + '.xlsx';
                document.body.appendChild(a);
                a.click();
                window.URL.revokeObjectURL(url);
                a.remove();
    ...
    self.exportTopSubCriteriaToExcel = function() {
        ...
        customerApiFetch(url)
            ...
            .then(function(blob) {
                ...
                var a = document.createElement('a');
                a.href = url;
                a.download = 'EnCokSecilenAltKriterler_' + formatLocalDate(new Date()) + '.xlsx';
                document.body.appendChild(a);
                a.click();
                window.URL.revokeObjectURL(url);
                a.remove();
