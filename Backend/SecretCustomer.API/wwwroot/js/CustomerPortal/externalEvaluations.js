function CustomerExternalEvaluationsViewModel() {
    var self = this;
    ...
    self.saveFilter = function() {
        ...
        var filterData = {
            ...
            page: '/CustomerPortal/ExternalEvaluations',
    ...
    self.loadSavedFilters = function() {
        ...
        customerApiFetch('/api/customer/portal/saved-filters?page=/CustomerPortal/ExternalEvaluations')
            .then(function(response) { return response.json(); })
            .then(function(data) {
...
$(document).ready(function() {
    ko.applyBindings(new CustomerExternalEvaluationsViewModel(), document.getElementById('customer-external-evaluations-app'));
});
