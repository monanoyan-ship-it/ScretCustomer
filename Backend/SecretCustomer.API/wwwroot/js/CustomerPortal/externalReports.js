function CustomerExternalReportsViewModel() {
    var self = this;
...
$(document).ready(function() {
    ko.applyBindings(new CustomerExternalReportsViewModel(), document.getElementById('customer-external-reports-app'));
});
