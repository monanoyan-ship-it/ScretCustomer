...
public class FieldWorkerService : IFieldWorkerService
{
    ...
    public async Task<List<PendingDealerDto>> GetPendingDealersAsync(int userId)
    {
        ...
        return pendingDealers.Select(acd => new PendingDealerDto
        {
            ...
            ProjectName = acd.Assignment.Project != null ? (acd.Assignment.Project.Code != null ? acd.Assignment.Project.Code + " - " + acd.Assignment.Project.Name : acd.Assignment.Project.Name) ?? "" : "",
