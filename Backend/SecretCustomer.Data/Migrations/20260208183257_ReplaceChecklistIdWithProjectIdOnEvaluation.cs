...
{
    /// <inheritdoc />
    public partial class ReplaceChecklistIdWithProjectIdOnEvaluation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // === STEP 1: FK'ları kaldır (kolon silmeden önce) ===
            ...
            // === STEP 2: ProjectId kolonu ekle (nullable) ===
            ...
            // === STEP 3: Backfill - Assignment üzerinden ProjectId doldur ===
            migrationBuilder.Sql(
                @"UPDATE ""Evaluations"" e
                  SET ""ProjectId"" = a.""ProjectId""
                  FROM ""Assignments"" a
                  WHERE e.""AssignmentId"" = a.""Id"" AND e.""AssignmentId"" IS NOT NULL;");

            // === STEP 4: Backfill - Assignment olmayan kayıtlar (anketler vb.) ChecklistId üzerinden ===
            migrationBuilder.Sql(
                @"UPDATE ""Evaluations"" e
                  SET ""ProjectId"" = p.""Id""
                  FROM ""Projects"" p
                  WHERE e.""ProjectId"" IS NULL
                    AND e.""ChecklistId"" = p.""ChecklistId""
                    AND NOT p.""IsDeleted"";");

            // === STEP 5: Hala NULL kalanlar varsa ilk uygun projeyi ata ===
            migrationBuilder.Sql(
                @"UPDATE ""Evaluations"" e
                  SET ""ProjectId"" = (
                    SELECT p.""Id"" FROM ""Projects"" p
                    WHERE p.""ChecklistId"" = e.""ChecklistId""
                    ORDER BY p.""Id"" LIMIT 1
                  ) WHERE e.""ProjectId"" IS NULL;");

            // === STEP 6: ProjectId NOT NULL yap ===
            ...
            // === STEP 7: Eski kolonları ve indexleri sil ===
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                name: "IX_Evaluations_ProjectId",
                table: "Evaluations",
                newName: "IX_Evaluations_ChecklistId");
