...
public class Personnel : BaseEntity
{
    ...
    [ExcelColumn("TC Kimlik No", 3, ColumnType = ExcelColumnType.Text,
        Description = "TC Kimlik Numarası", SampleValue = "12345678901")]
    public string? TcKimlikNo { get; set; }

    [ExcelColumn("ERP No", 4, ColumnType = ExcelColumnType.Text,
        Description = "ERP Numarası", SampleValue = "ERP001")]
    public string? ErpNo { get; set; }

    [ExcelColumn("Sicil No", 5, ColumnType = ExcelColumnType.Text,
        Description = "Sicil Numarası", SampleValue = "SCL001")]
    public string? SicilNo { get; set; }

    [ExcelColumn("Unvan", 6, ColumnType = ExcelColumnType.Text,
        Description = "Personelin unvanı", SampleValue = "Müşteri Temsilcisi")]
    public string? Title { get; set; }

    [ExcelColumn("Cinsiyet", 7, ColumnType = ExcelColumnType.Dropdown,
        Description = "Cinsiyet",
        DropdownOptions = "[\"Erkek\", \"Kadın\", \"Belirtilmemiş\"]",
        SampleValue = "Erkek")]
    public Gender Gender { get; set; } = Gender.Unspecified;

    [ExcelColumn("Doğum Tarihi", 8, ColumnType = ExcelColumnType.Date,
        Description = "Doğum tarihi")]
    public DateTime? BirthDate { get; set; }

    [ExcelColumn("İşe Başlama Tarihi", 9, ColumnType = ExcelColumnType.Date,
        Description = "İşe başlama tarihi")]
    public DateTime? HireDate { get; set; }

    [ExcelColumn("E-posta", 10, ColumnType = ExcelColumnType.Email,
        Description = "E-posta adresi", SampleValue = "ahmet.yilmaz@example.com")]
    public string? Email { get; set; }

    [ExcelColumn("Telefon", 11, ColumnType = ExcelColumnType.Phone,
        Description = "Telefon numarası", SampleValue = "0532 123 4567")]
    public string? PhoneNumber { get; set; }

    [ExcelColumn("Departman", 12, ColumnType = ExcelColumnType.Text,
        Description = "Departman", SampleValue = "Müşteri Hizmetleri")]
    public string? Department { get; set; }

    [ExcelColumn("Aktif", 13, ColumnType = ExcelColumnType.Boolean,
        Description = "Personelin aktif olup olmadığı", SampleValue = "true")]
    public bool IsActive { get; set; } = true;

    [ExcelColumn("Notlar", 14, ColumnType = ExcelColumnType.Text,
