...
{
    [ExcelColumn("Proje Kodu", 1, ColumnType = ExcelColumnTypes.Ids.Text,
        Description = "Proje kodu", SampleValue = "PRJ-2025-001")]
    public string? Code { get; set; }

    [ExcelColumn("Proje Adi", 2, IsRequired = true, ColumnType = ExcelColumnTypes.Ids.Text,
        Description = "Projenin adi", SampleValue = "2024 Musteri Memnuniyeti Projesi")]
    public string Name { get; set; } = string.Empty;

    [ExcelColumn("Aciklama", 3, ColumnType = ExcelColumnTypes.Ids.Text,
    ...
    [ExcelColumn("Proje Tipi", 4, IsRequired = true, ColumnType = ExcelColumnTypes.Ids.Dropdown,
    ...
    public int ProjectTypeId { get; set; } = ProjectTypes.Ids.MysteryShopping;

    [ExcelColumn("Proje Durumu", 5, ColumnType = ExcelColumnTypes.Ids.Dropdown,
        Description = "Proje durumu",
        DropdownOptions = "[\"Draft\", \"Planned\", \"Active\", \"Paused\", \"Completed\", \"Cancelled\"]",
        SampleValue = "Active")]
    public int StatusId { get; set; } = ProjectStatuses.Ids.Draft;

    [ExcelColumn("Atama Tipi", 6, IsRequired = true, ColumnType = ExcelColumnTypes.Ids.Dropdown,
    ...
    [ExcelColumn("Baslangic Tarihi", 7, IsRequired = true, ColumnType = ExcelColumnTypes.Ids.Date,
        Description = "Projenin baslangic tarihi", SampleValue = "2024-01-01")]
    public DateTime StartDate { get; set; }

    [ExcelColumn("Bitis Tarihi", 8, IsRequired = true, ColumnType = ExcelColumnTypes.Ids.Date,
    ...
    /// </summary>
    [ExcelColumn("Hedef Sayi", 10, ColumnType = ExcelColumnTypes.Ids.Number,
    ...
    /// Gunluk kota
    /// </summary>
    [ExcelColumn("Gunluk Kota", 11, ColumnType = ExcelColumnTypes.Ids.Number,
    ...
    /// Haftalik kota
    /// </summary>
    [ExcelColumn("Haftalik Kota", 12, ColumnType = ExcelColumnTypes.Ids.Number,
    ...
    /// Aylik kota
    /// </summary>
    [ExcelColumn("Aylik Kota", 13, ColumnType = ExcelColumnTypes.Ids.Number,
    ...
    /// Tahmini butce
    /// </summary>
    [ExcelColumn("Tahmini Butce", 14, ColumnType = ExcelColumnTypes.Ids.Number,
    ...
    /// Gerceklesen butce
    /// </summary>
    [ExcelColumn("Gerceklesen Butce", 15, ColumnType = ExcelColumnTypes.Ids.Number,
    ...
    /// </summary>
    [ExcelColumn("Birim Ucret", 16, ColumnType = ExcelColumnTypes.Ids.Number,
    ...
    /// </summary>
    [ExcelColumn("Raporlama Sikligi", 17, ColumnType = ExcelColumnTypes.Ids.Number,
    ...
    /// </summary>
    [ExcelColumn("Otomatik Rapor", 18, ColumnType = ExcelColumnTypes.Ids.Boolean,
    ...
    /// </summary>
    [ExcelColumn("Minimum Puan", 19, ColumnType = ExcelColumnTypes.Ids.Number,
    ...
    /// Proje onceligi
    /// </summary>
    [ExcelColumn("Oncelik", 20, ColumnType = ExcelColumnTypes.Ids.Dropdown,
    ...
    /// </summary>
    [ExcelColumn("Etiketler", 21, ColumnType = ExcelColumnTypes.Ids.Text,
